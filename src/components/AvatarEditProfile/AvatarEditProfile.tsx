...
interface AvatarEditProfileProps {
  ...
  lastVisit: string;
  onEdit: () => void;
  isEditing: boolean; // Nuevo prop para habilitar la edición de la foto
  onAvatarChange: (e: React.ChangeEvent<HTMLInputElement>) => void; // Función para cambiar la foto
}

const AvatarEditProfile: React.FC<AvatarEditProfileProps> = ({
  avatarUrl,
  userName,
  lastVisit,
  onEdit,
